...
# ╔═╡ e3caad10-376b-4e10-b883-209cf2360be2
println(arreglo_aleatorio)
...
# ╔═╡ 92fb0850-50c5-478a-868d-827bae4e2750
arte_de_pixeles= [RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0)
 RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0) 
RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0)
 RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0)
RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0)
RGB(0, 1, 0)  RGB(0, 1, 0) RGB(0, 1, 0)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 0, 0) RGB(1, 0, 0)  RGB(1, 0, 0)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "affc4c23a3fb8bf84b0af1568efc7d2df847136d"
