...
# ╔═╡ 80cabaee-d4ca-4c5d-976c-69969c407c96
using StatsPlots
...
# ╔═╡ 7a82a44c-820c-4bc2-bc80-c6cd3090a678
...
# ╔═╡ d193a320-9323-487d-b8d7-5212d130d14d
...
# ╔═╡ 83d14ad0-171e-42d6-a1b1-7edfab4bb233
md"""
...
# ╔═╡ 400791b5-b346-4282-9cdd-68f4c16280b1
...
# ╔═╡ 10c5bca9-88f2-4279-9f44-760276317782
...
# ╔═╡ a2c90782-4a49-4438-a0c7-5378d42c1858
...
# ╔═╡ 3f23a492-061a-4814-8589-db2f0b49b4b1
...
# ╔═╡ 31d86bc2-7302-41f7-bfa7-9bf3b178a303
...
# ╔═╡ 2d219fec-36ab-4766-bafc-47a2ff25f3a0
md"""## Histogramas
...
# ╔═╡ bf8f1e95-8ec6-4428-ac0f-7fbce073750c
histogram([1,2,1,1,4,3,8], legend=false)

# ╔═╡ cf9fea9f-6e55-4fef-b495-5871e5c259aa
md"""
...
# ╔═╡ b69c3772-61e2-4e09-a5b8-d74c0b22908a
...
# ╔═╡ 38a5178a-d0cd-4f8d-93cf-0ca692787094
md"""## _Pie charts_
...
# ╔═╡ a3931f84-e44f-490b-80b3-eadc766c530b
M = rand(1,2) #Generamos una matriz de 8x8 con entradas aleatorias entre 0 y 1.=#

# ╔═╡ feedcd08-43af-4af6-b1cb-14c5a0e0c1b7
heatmap(M) #Graficamos la matriz como un mapa de calor.

# ╔═╡ eb1415ff-b292-45f0-8ccd-ad6a16ed2b16
md"""
...
# ╔═╡ 8f22d6e0-28c7-41f9-af97-c107bdd81bcc
md"""## Subfiguras
...
# ╔═╡ 9755a4ca-584e-4810-96f0-a5599b4f9a42
begin
...
# ╔═╡ b4a6bafd-b921-4bbb-a7a5-c9dac845adb5
...
# ╔═╡ 53afc0b3-f26c-4fe6-abae-4fc0cf5ecf49
...
# ╔═╡ 65aa6d2b-2d03-4d60-8fe4-7760565f875e
plot(p1, p2, p3, p4, p5, p6)
#Usamos las variables como argumento de la función plot.

# ╔═╡ 1817ee5a-5c7c-4b32-be05-3456f71757d4
md""" ### _Layouts_
...
# ╔═╡ 68907259-569d-42f0-88d9-b40a27362823
begin
	
lay = @layout [a b c d ; e j]
	
end

# ╔═╡ 426e557e-abbc-41d0-8270-9d9233b91116
plot(p1, p2, p3, p4, p5, p6, layout = lay)

# ╔═╡ c69d1525-0e9c-49d2-8fb4-c4e9d840de1a
...
# ╔═╡ cc3216a9-6174-4ae7-8db4-c124a2495678
savefig(plot(p1, p2, p3, p4, p5, p6, layout = lay), "miFigura.pdf")

# ╔═╡ 8e934afd-64c8-4721-9a9f-d8d9082ecc51
md"""
...
# ╔═╡ 4d4e5794-4aca-4ccc-af0f-99a3e3ec2858
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "933cf51e6eb89721c79ef68f14d642f19616eac6"
